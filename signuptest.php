...
if (isset($_POST['register_btn'])) {
    ...
    $sqlu = "SELECT * FROM usertable where username='$username'";
    $result = mysqli_query($db,$sqlu) or die(mysqli_error($db));
...
<form action="signup.php" method="POST">
    <div class="container">
        ...
        <label for="contact"><b>Email</b></label>
        <input class="log" type="text" placeholder="Enter Email" name="email" required>
